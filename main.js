...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFetchBitcoin)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n\n\nfunction initFetchBitcoin() {\n  function activeBitcoin() {\n    return _activeBitcoin.apply(this, arguments);\n  }\n  function _activeBitcoin() {\n    _activeBitcoin = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {\n      var responseBitcoin, bitcoinJson, btc, valor;\n      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {\n        while (1) switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return fetch('https://blockchain.info/ticker');\n          case 3:\n            responseBitcoin = _context.sent;\n            _context.next = 6;\n            return responseBitcoin.json();\n          case 6:\n            bitcoinJson = _context.sent;\n            btc = document.querySelector('.btc-container');\n            valor = (100 / bitcoinJson.BRL.buy).toFixed(4);\n            btc.innerHTML = \"Doe <span class=\\\"btc\\\">\".concat(valor, \"</span> bitcoin para nos ajudar\");\n            _context.next = 15;\n            break;\n          case 12:\n            _context.prev = 12;\n            _context.t0 = _context[\"catch\"](0);\n            console.log(Error(_context.t0));\n          case 15:\n          case \"end\":\n            return _context.stop();\n        }\n      }, _callee, null, [[0, 12]]);\n    }));\n    return _activeBitcoin.apply(this, arguments);\n  }\n  activeBitcoin();\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/fetch-bitcoin.js?");

/***/ }),

/***/ "./js/modules/horario-semana.js":
/*!**************************************!*\
  !*** ./js/modules/horario-semana.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initHorarioSemana)\n/* harmony export */ });\nfunction initHorarioSemana() {\n  var data = document.querySelector(\"[data-semana]\");\n  var dataAtual = new Date();\n  var semana = data.dataset.semana.split(\",\").map(function (item) {\n    return +item;\n  });\n  var horas = data.dataset.horario.split(\",\").map(function (item) {\n    return +item;\n  });\n  var aberto = semana.includes(dataAtual.getDay()) && dataAtual.getHours() >= horas[0] && dataAtual.getHours() < horas[1];\n  if (aberto) {\n    data.classList.add(\"aberto\");\n  } else if (data.classList.contains(\"aberto\")) {\n    data.classList.remove(\"aberto\");\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/horario-semana.js?");
